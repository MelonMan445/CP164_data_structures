...
class List:
    ...
    def _swap(self, i, j):
        ...
        # Your code here
        temp = deepcopy(self._values[i])
        self._values[i] = deepcopy(self._values[j])
        self._values[j] = temp
    ...
    def insert(self, i, value):
        ...
        if -len(self._values) <= i <= len(self._values) - 1:
            self._values.insert(i, value)  # Use correct list attribute
        elif i > len(self._values) - 1:
            self._values.append(value)  # Append if index is too large
    ...
    def reverse(self):
        ...
        -------------------------------------------------------
        """
        self._values = self._values[::-1]  # Your code here
